...
//public class ElementsTestNotActual {
//
//@BeforeEach
//    void setup() {
//
...
//    @Test
//    @Tag("SMOKE")
//    @DisplayName("Тест на проверку открытия Главной в новой вкладке")
//    public void openHomePageOnNewTab() {
//
//    $(byText("Links")).click();
//    $("#simpleLink").click();
//    sleep(50000);
//    String url = url();
//    url.contains("https://demoqa.com/");
//
//    }
//
//}
